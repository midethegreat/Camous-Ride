...
import { CreditCard, Bitcoin, CheckCircle2, XCircle } from "lucide-react-native";
...
const DepositReceipt = ({ route }: { route: DepositReceiptRoute }) => {
  ...
  const handleDownload = () => {
    Alert.alert("Not Available", "Saving receipt image is not available in Expo Go.");
  };
        ...
        <View style={styles.receiptInner}>
          ...
          <View style={styles.footerNote}>
            ...
            <Text style={styles.noteText}>
              Funds are added to your CampusRide wallet. Keep this receipt for your records.
            </Text>
          </View>
        </View>
